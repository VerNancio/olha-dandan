    ...
    <header class="bg-white">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <?php
                echo ((@$_SESSION['admin'] == 1 || @$_SESSION['admin'] == 0) & isset($_SESSION['admin']) ?
                '<a href=".\admin_pages\main.php" class="text-sm font-semibold leading-6 text-gray-900">Admin<span aria-hidden="true">&rarr;</span></a>'
                :
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div class="py-6">
                            <?php
                            echo ((@$_SESSION['admin'] == 1 || @$_SESSION['admin'] == 0) & isset($_SESSION['admin']) ?
                            '<a href=".\admin_pages\login.php" class="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Admin</a>'
                            :
