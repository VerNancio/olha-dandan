...
<body>
    ...
    <header>
        <div class="navbar" onclick="voltar()">
            <i class="bi bi-arrow-return-left"></i>
            <span>Voltar - Admin Page</span>
        </div>
    </header>
        ...
        '<div class="container-insert-news">
            <form method="post" action="..\ops\gerencia_noticias.php?operacao=editar">
                ...
                <div class="input-control">
                    ...
                    <textarea name="news-summary" value="'. $noticia['RESUMO'] .'" maxlength="300" id="news-summary" cols="30" rows="10" placeholder="Insira um resumo da notícia" required></textarea>
                </div>
                <div class="input-control">
                    <label for="">Noticia</label>
                    <textarea name="news" value="'. $noticia['NOTICIA'] .'" id="news" cols="30" rows="10" placeholder="Insira a notícia" required></textarea>
                </div>
